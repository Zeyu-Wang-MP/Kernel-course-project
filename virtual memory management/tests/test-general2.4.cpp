...
int main()
{
    ...
    char *indisk_file1 = (char *) vm_map (swapblock_page, 1);
    char *indisk_file3 = (char *) vm_map (swapblock_page, 3);
...
for (unsigned int i=0; i<30; i++) {
    ...
    char *in_memory_file = (char *) vm_map (physmem_swap, 0);
    cout << "swapblock_page name: " << swapblock_page << std::endl;
    strcpy(physmem_swap, swapblock_page);
    cout << (swapblock_page == physmem_swap) << std::endl;
