...
int main()
{
    ...
    if(fork() == 0)
    {
        ...
        strcpy(inmem_r1w1, "data3.bin");
        cout << inmem_r1w1 << endl;
        strcpy(indisk_r0w0, "data3.bin");
        cout << indisk_r0w0 << endl;
        strcpy(pinned_r1w0, "data3.bin");
        cout << pinned_r1w0 << endl;
        ...
        else
        {
            ...
            vm_yield();
            strcpy(inmem_r1w1, "data4.bin");
            cout << inmem_r1w1 << endl;
            strcpy(indisk_r0w0, "data4.bin");
            cout << indisk_r0w0 << endl;
            strcpy(pinned_r1w0, "data4.bin");
            cout << pinned_r1w0 << endl;
    ...
    // 4 processes call this. Output should be different for all.
    // should be the 4 different bin file names.
    cout << inmem_r1w1 << endl; 
    cout << indisk_r0w0 << endl; 
    cout << pinned_r1w0 << endl;
