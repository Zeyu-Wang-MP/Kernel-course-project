...
/*
    Tests that create chooses lowest available direntry
*/
...

{
    ...
    fs_delete("user1", "password1", session, seq++, "/child2");
    fs_delete("user1", "password1", session, seq++, "/child4");
    fs_delete("user1", "password1", session, seq++, "/child6");

    fs_writeblock("user1", "password1", session, seq++, "/child8", 0, writedata);
    fs_readblock("user1", "password1", session, seq++, "/child8", 0, readdata);
