...
/*
    Tests that delete correctly decrements size
*/
...

{
    ...
    fs_session("user2", "password2", &session_two, seq++);
    fs_create("user1", "password1", session_two, seq++, "/child1", 'd');
    fs_create("user1", "password1", session, seq, "/child2", 'f');
    fs_create("user1", "password1", session, seq, "/child3", 'd');
    fs_create("user1", "password1", session, seq + 1, "/child4", 'f');
    fs_create("user1", "password1", session, seq - 1, "/child5", 'd');
