 ...
 * Encryption type defaults to CLEAR; to use AES encryption, set the FS_CRYPT
 * environment variable to AES.
 *
...
/*
 * Decrypt data using CLEAR or AES encryption, using the null-terminated string in
